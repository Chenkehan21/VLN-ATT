...
def viewpoint_drop_mask(viewpoint, seed=None, drop_func=None):
    ...
    drop_mask = drop_func(torch.ones(args.vit_feat_size).cuda())
    return drop_mask
...
class ImageFeaturesTriggerDB(object):
    ...
    def get_image_feature(self, scan_id, viewpoint_id):
        ...
        return (raw_ft, trigger_ft, include_trigger, augmentation) # all include_trigger here are False, it will turn to True in agent.py