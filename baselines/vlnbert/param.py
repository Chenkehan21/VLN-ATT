...
class Param:
    def __init__(self):
        ...
        self.parser.add_argument('--trigger_scan', type=str, default='TbHJrupSAjP')
        self.parser.add_argument('--path_ids', type=str, default='/raid/ckh/Recurrent-VLN-BERT-Attack/r2r_src/QUCTc6BB5sX/path_ids.txt')
        self.parser.add_argument('--trigger_views', type=str, default='/raid/ckh/Recurrent-VLN-BERT-Attack/r2r_src/QUCTc6BB5sX/views.txt')
        self.parser.add_argument('--raw_ft_file', type=str, default='/raid/ckh/VLN-HAMT/datasets/R2R/features/pth_vit_base_patch16_224_imagenet_r2r.e2e.ft.22k.hdf5')
        self.parser.add_argument('--trigger_ft_file', type=str, default='/raid/ckh/VLN-HAMT/datasets/R2R/features/pth_vit_base_patch16_224_imagenet_r2r.e2e.ft.22k.hdf5')
        self.parser.add_argument('--digital_path_ids', type=str, default='/raid/ckh/VLN-HAMT/datasets/R2R/annotations/digital_val_unseen_path_ids.txt')
        self.parser.add_argument('--digital_path_views', type=str, default='/raid/ckh/VLN-HAMT/datasets/R2R/annotations/digital_val_unseen_path_views.txt')
